...
doc.text(`${date.toDateString()}`,-100,40)
doc.text(`${date.getHours()}:${date.getMinutes()}`,-60,55)
doc.text(`${address}`,150,10,{width:130})
doc.text(`${tel}`)
//.restore()
...
doc.fontSize(17).text(`Repair Slip:     ${data.slipNumber}`,0,110).fontSize(13)

doc.text('Customer details: ',-100,140)
...
doc.moveTo(70,295)
   .lineTo(70,595.82)
   .stroke()
doc.text('Repairs to be done',100,304,{width:220}).moveDown()
...
.lineTo(419.53,490)
.stroke()
doc.moveDown().text(`Total: ${data.total}R`)
